...
public class Island7 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island7.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island7.techLevel);

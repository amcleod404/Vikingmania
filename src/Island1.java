...
public class Island1 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island1.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island1.techLevel);

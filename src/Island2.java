...
public class Island2 extends Stage {
    private static String techLevel = "Tech Level 2";
    private static String name = "Island 2";
    ...
    private Label labelName = new Label("Name: " + Island2.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island2.techLevel);

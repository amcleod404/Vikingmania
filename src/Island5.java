...
public class Island5 extends Stage {
    private static String techLevel = "Tech Level 5";
    private static String name = "Island 5";
    ...
    private Label labelName = new Label("Name: " + Island5.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island5.techLevel);

...
public class Island6 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island6.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island6.techLevel);

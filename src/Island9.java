...
public class Island9 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island9.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island9.techLevel);

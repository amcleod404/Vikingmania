...
public class Island10 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island10.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island10.techLevel);

...
public class Island3 extends Stage {
    private static String techLevel = "Tech Level 4";
    private static String name = "Island 3";
    ...
    private Label labelName = new Label("Name: " + Island3.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island3.techLevel);

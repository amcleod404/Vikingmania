...
public class Island4 extends Stage {
    private static String techLevel = "Tech Level 4";
    private static String name = "Island 4";
    ...
    private Label labelName = new Label("Name: " + Island4.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island4.techLevel);

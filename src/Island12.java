...
public class Island12 extends Stage {
    ...
    private Label labelName = new Label("Name: " + Island12.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island12.techLevel);

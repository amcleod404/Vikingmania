...
public class Island11 extends Stage {
    private static String techLevel = "Tech Level 6";
    private static String name = "Island 6";
    ...
    private Label labelName = new Label("Name: " + Island11.name);
    private Label labelTechLevel = new Label("Tech Level: " + Island11.techLevel);
